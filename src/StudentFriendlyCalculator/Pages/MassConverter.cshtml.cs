...
{
    public class MassConvertertModel : PageModel
    {
        private readonly ILogger<MassConvertertModel> _logger;

        public MassConvertertModel(ILogger<MassConvertertModel> logger)
        {
            _logger = logger;
        }
